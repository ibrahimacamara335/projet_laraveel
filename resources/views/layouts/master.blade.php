        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('afficher.formation')}}">Formations</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('afficher-referentiel')}}">Referentiels</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('afficher-candidat')}}">Candidats</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('type-liste')}}">Types</a>
                    </li>
